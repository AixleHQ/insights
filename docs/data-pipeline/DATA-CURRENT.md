...
`metadata.repo_name` always reflects Cursor’s commit row regardless of attribution. Dashboards can show repo/branch even when `project_id` is null (no matching Aixle Insights project).
