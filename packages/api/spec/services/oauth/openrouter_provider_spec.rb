...
RSpec.describe Oauth::OpenrouterProvider, type: :service do
  let(:connector) { instance_double('OrganizationConnector', access_token: 'sk-or-test123') }
    ...
    context 'when the API key is valid' do
      it 'returns success' do
        stub_request(:get, 'https://openrouter.ai/api/v1/models')
          .with(headers: { 'Authorization' => 'Bearer sk-or-test123' })
