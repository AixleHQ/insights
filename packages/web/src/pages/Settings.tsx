...
export function SecuritySettings() {
  ...
  const canViewUnified = hasRole("owner") || Boolean(me?.globalAdmin ?? me?.super_admin);
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="org">
        <TabsList>
          ...
          {canViewUnified && (
            <TabsTrigger value="unified">Unified Timeline</TabsTrigger>
          )}
        </TabsList>
        ...
        {canViewUnified && (
          <TabsContent value="unified" className="mt-4">
            <UnifiedAuditTimelineTab orgId={currentOrg?.id ?? ""} />
          </TabsContent>
        )}
      </Tabs>
    </div>
