...
GHCR_RUBY="ghcr.io/AixleHQ/insights/ruby:3.4.8-slim"
...
if ghcr_available; then
  ...
  for img in \
    ghcr.io/AixleHQ/insights/ruby:3.4.8-slim \
    ghcr.io/AixleHQ/insights/node:24.13.0-slim \
    ghcr.io/AixleHQ/insights/nginx:alpine; do
